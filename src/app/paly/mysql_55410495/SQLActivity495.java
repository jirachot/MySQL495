package app.paly.mysql_55410495;
...
public class SQLActivity495 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sqlactivity495);
    ...
    class CreateNewStudent extends AsyncTask<String, String, String>{
    	...
    	protected void onPreExecute() {
    		super.onPreExecute();
    		pDialog = new ProgressDialog(SQLActivity495.this);
